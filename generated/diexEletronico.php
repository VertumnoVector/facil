...
//DECLARE ENTRE AS ''  OS NOMES
$fiscal = 'EDERVALDO JOSÉ  DE SOUZA MELO - Cap';
$cmt = 'CARLOS ALEXANDRE BASTOS DE VASCONCELLOS - Cel';
//FIM DAS DECLARAÇÕES
...
Ao Sr Fisc Adm','BLR',0); 
            $this->MultiCell($width_cell[2],5,'Solicito que o material permanente abaixo relacionado seja descarregado, conforme inciso I, §1º, art. 76 do EB10-R-01.003 (RAE).','BLR',0);
...
2.  Seja descarregado o material constante no presente DIEx, conforme inciso I, §1º, art. 76 do EB10-R-01.003 (RAE), e de acordo com  Aditamento nº 003 - Div Log ao Boletim Interno nº 029 do CCOMGEX.      
